...
if ((Test-Path -LiteralPath $InstallRoot) -and $PSCmdlet.ShouldProcess($InstallRoot, "Delete service files")) {
...
if ($DeleteData -and (Test-Path -LiteralPath $DataRoot)
    -and $PSCmdlet.ShouldProcess($DataRoot, "Delete temporary service data")) {
