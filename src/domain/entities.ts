/**
 * Domain contracts (rule PROC-001..003; source `docs/topographic-adjustment/DOMAINE-ET-STARNET.md`).
 *
 ...
 * `docs/topographic-adjustment/DOMAINE-ET-STARNET.md` directly — never ported from the old StarNet
...
export interface TopographicAdjustmentProcessing {
  ...
  /**
   * Lifecycle/runtime state shown in the administration list (PRODUIT-ET-PARCOURS.md). Distinct from
