...
// Station/StationPrismSetup types. Behaviour and tolerances follow `front/12 §Common physical
...
/**
 * Pairwise station connectivity pre-check (PROC-004/005, `front/12 §7`): with unknown relative
